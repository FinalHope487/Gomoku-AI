...
def parse_args():
    ...
    parser.add_argument("--max-candidates", type=int, default=16, help="candidate move cap")
...
def evaluate(board, player: int) -> int:
    ...
    # Black 3 (Variant 2): Higher OPP_WEIGHT for defensive posture
    return mine - int(opp * 1.3)
