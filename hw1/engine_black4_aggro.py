...
def evaluate(board, player: int) -> int:
    ...
    # Black 4 (Aggressive): Minimal defense, focuses heavily on offense
    return mine - int(opp * 0.4)
...
def move_priority(board, x: int, y: int, player: int) -> int:
    ...
    # Black 4 (Aggressive): self_score given heavy weight, block_score reduced
    return (
